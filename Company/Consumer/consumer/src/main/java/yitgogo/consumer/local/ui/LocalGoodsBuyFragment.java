...
public class LocalGoodsBuyFragment extends BaseNetworkFragment {
    ...
    private void countTotalMoney() {
        totalMoney = 0;
        double goodsMoney = goodsCount * goods.getRetailPrice();
        double postFee = 0;
    ...
    private void getStoreInfo() {
        ...
        requestParams.add(new RequestParam("no", goods.getProviderBean().getNo()));
