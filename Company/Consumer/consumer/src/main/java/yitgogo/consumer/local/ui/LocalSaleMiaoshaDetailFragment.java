...
public class LocalSaleMiaoshaDetailFragment extends BaseNetworkFragment {
    ...
    protected void initViews() {
        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ApplicationTool.getScreenWidth());
    ...
    private void getDetail() {
        ...
        post(API.API_LOCAL_SALE_MIAOSHA_DETAIL, requestParams, new OnNetworkListener() {
            @Override
