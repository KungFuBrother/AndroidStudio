 ...
 */
public class LocalStoreGoodsFragment extends BaseNetworkFragment implements
        OnClickListener {
    ...
    private void getGoods() {
        ...
        requestParams.add(new RequestParam("shopServiceProviderID", storeId));
        ...
        if (localGoodsClasses2.getSelection() >= 0) {
            if (localGoodsClasses2.getGoodsClasses().size() > localGoodsClasses2
                ...
                requestParams.add(new RequestParam("retailProTypeValueID", classId));
            }
        }
    ...
    private void getGoodsClasses() {
        ...
        requestParams.add(new RequestParam("serviceProviderID", Store.getStore().getStoreId()));
        requestParams.add(new RequestParam("shopServiceProviderID", storeId));
        post(API.API_LOCAL_BUSINESS_GOODS_CLASS_PRIMARY, requestParams, new OnNetworkListener() {
            @Override
            public void onSuccess(String result) {
                try {
    ...
    private void getGoodsClasses(String productTypeValueID) {
        List<RequestParam> requestParams = new ArrayList<>();
        requestParams.add(new RequestParam("serviceProviderID", Store.getStore().getStoreId()));
        requestParams.add(new RequestParam("shopServiceProviderID", storeId));
        requestParams.add(new RequestParam("productTypeValueID", productTypeValueID));
        post(API.API_LOCAL_BUSINESS_GOODS_CLASS_SECOND, requestParams, new OnNetworkListener() {
            @Override
            public void onSuccess(String result) {
                try {
    ...
    class GoodsClassSelector extends BaseFragment {
            ...
            primaryListView.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    if (arg2 == 0) {
                        ...
                        getGoodsClasses(localGoodsClasses.getGoodsClasses().get(arg2).getId());
                    }
                }
            });
