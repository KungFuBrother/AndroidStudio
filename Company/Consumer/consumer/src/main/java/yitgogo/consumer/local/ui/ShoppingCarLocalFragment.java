...
public class ShoppingCarLocalFragment extends BaseNetworkFragment implements
        OnClickListener {
            ...
            case R.id.car_buy:
                if (User.getUser().isLogin()) {
                    if (totalMoney > 0) {
                        ...
                        ApplicationTool.showToast("请选择要购买商品");
                    }
                } else {
    ...
    class GetStoreInfo extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            for (int i = 0; i < localCars.size(); i++) {
                ...
                String result = NetUtil.getInstance().postWithoutCookie(
