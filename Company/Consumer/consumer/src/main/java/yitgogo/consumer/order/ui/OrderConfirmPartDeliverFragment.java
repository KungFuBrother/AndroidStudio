...
public class OrderConfirmPartDeliverFragment extends BaseFragment {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.order_deliver_tohome) {
                    if (buyCount < deliverNum) {
                        ApplicationTool.showToast("购满" + deliverNum + "件才可享受送货上门服务");
                        sendTypeGroup.check(R.id.order_deliver_self);
                    }
                }
                selectDeliverType();
     ...
     * 初始化配送方式
     *
     * @param deliverYN  是否支持送货上门
     * @param deliverNum 满多少送货
     */
