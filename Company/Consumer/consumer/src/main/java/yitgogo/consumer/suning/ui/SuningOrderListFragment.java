...
public class SuningOrderListFragment extends BaseNetworkFragment {
    ...
    private void getSuningOrder() {
        ...
        post(API.API_SUNING_ORDER_LIST, requestParams, new OnNetworkListener() {
            @Override
