...
public class NetUtil {
    ...
    private void showParameters(String url, List<NameValuePair> nameValuePairs) {
        ApplicationTool.log("Request Url", url);
        if (nameValuePairs == null) {
            ApplicationTool.log("Request Parameters", "No Parameters");
        } else {
            ApplicationTool.log("Request Parameters", nameValuePairs.toString());
        }
    }
    ...
    public String postAndSaveCookie(String url,
        ...
        httpPost.setHeader("version", ApplicationTool.getVersionName());
        try {
            if (nameValuePairs != null) {
            ...
            if (statue == 200) {
                ...
                if (cookies.size() > 0) {
                    ...
                    ApplicationTool.log("Request Save_Cookie", builder.toString());
                ...
                ApplicationTool.log("Request Status", statue + "");
                return "";
            }
        } catch (ConnectTimeoutException e) {
            ApplicationTool.log("Request Status", "网络连接超时");
            return "";
        ...
        ApplicationTool.log("Request Result", stringBuilder.toString());
    ...
    public String postWithCookie(String url, List<NameValuePair> nameValuePairs) {
        ...
        if (url.startsWith(API.IP_MONEY)) {
            if (Content.contain(Parameters.CACHE_KEY_COOKIE_MONEY)) {
                ApplicationTool.log("Request Put_Cookie", Content.getStringContent(
                        Parameters.CACHE_KEY_COOKIE_MONEY, ""));
        ...
        if (stringBuilder.toString().contains("NAUTH")) {
            ApplicationTool.log("Request Status", "会话过期");
...
//                            ApplicationTool.log("Request Get Cache", cacheString);
//                            return cacheString;
//                        }
//                    } else {
//                        ApplicationTool.log("Request Get Cache",
//                                "cache out of date");
//                    }
//                }
//            }
//        }
    ...
    private void saveCache(String url, List<NameValuePair> nameValuePairs,
                           String result) {
//        ApplicationTool.log("Request Save Cache", result);
