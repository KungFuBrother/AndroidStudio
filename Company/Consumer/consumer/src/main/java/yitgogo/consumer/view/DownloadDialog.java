...
public class DownloadDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(dialogView,
                new LayoutParams((ApplicationTool.getScreenWidth() / 5 * 4),
                        (ApplicationTool.getScreenWidth() / 5 * 4)));
        return dialog;
    }
    ...
    private void initViews() {
        FrameLayout.LayoutParams bottomLayoutParams = new FrameLayout.LayoutParams(
                ApplicationTool.getScreenWidth() / 5 * 3,
                ApplicationTool.getScreenWidth() / 5 * 3);
        bottomLayoutParams.gravity = Gravity.CENTER;
        FrameLayout.LayoutParams topLayoutParams = new FrameLayout.LayoutParams(
                ApplicationTool.getScreenWidth() / 40 * 23,
                ApplicationTool.getScreenWidth() / 40 * 23);
    ...
    private void checkLocalApk() {
        ...
        if (downloadFile.exists()) {
            ...
            if (info != null) {
                ...
                if (apkPackageName.equals(ApplicationTool.getPackageName()) && apkVerCode >= versionInfo.getVerCode()) {
                    downloaded = true;
                }
            }
        }
    ...
    class DownLoad extends AsyncTask<Void, Float, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpGet get = new HttpGet(
                    "http://updatePhone.yitos.net/android/ytgogo_consumer.apk");
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                ApplicationTool.showToast("下载失败");
            }
        }
    }
